...
namespace ContactService.Api.Modules
{
  public class PersonModule : ICarterModule
  {
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
      ...
      group.MapPost("/{id:guid}/contacts", async (Guid id, AddContactInfoCommand partialCommand, IMediator mediator) =>
      {
      ...
      group.MapDelete("/{personId:guid}/contacts/{contactId:guid}", async (Guid personId, Guid contactId, IMediator mediator) =>
      {
